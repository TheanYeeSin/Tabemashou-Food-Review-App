...
class ReviewConfigLayoutView extends StatefulWidget {
  ...
  @override
  State<ReviewConfigLayoutView> createState() => _ReviewConfigLayoutViewState();
}

class _ReviewConfigLayoutViewState extends State<ReviewConfigLayoutView> {
  final _layoutImages = {
    ReviewLayoutMode.list: "assets/layouts/list.png",
    ReviewLayoutMode.card: "assets/layouts/card.png",
    ReviewLayoutMode.grid: "assets/layouts/grid.png",
  };
