    ...
    body: Column(
      children: [
        ...
        ListTile(
          ...
          onTap: () async {
            await UrlLauncherService.launchUrlString(
              "https://github.com/TheanYeeSin/Tabemashou-Food-Review-App/blob/main/README.md#privacy-policy",
            );
          },
        ...
        ListTile(
          ...
          onTap: () async {
            await UrlLauncherService.launchUrlString(
              "https://github.com/TheanYeeSin/Tabemashou-Food-Review-App/blob/main/LICENSE",
            );
          },
          trailing: const Icon(Icons.chevron_right_outlined),
        ),
